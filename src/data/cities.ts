...
export const cities: City[] = [
  ...
  { id: 'akhtala', provinceId: 'gugark', nameHy: 'Ախթալա', nameEn: 'Akhtala', modernName: 'Akhtala', coordinates: [41.1509, 44.7632], category: 'city', note: 'A modern Lori city centered around its medieval fortress-monastery complex.' },
  ...
  { id: 'vanadzor', provinceId: 'gugark', nameHy: 'Վանաձոր', nameEn: 'Vanadzor', modernName: 'Vanadzor', coordinates: [40.8128, 44.4883], category: 'city', note: 'The largest modern city of Lori, located in the Pambak valley.' },
  { id: 'alaverdi', provinceId: 'gugark', nameHy: 'Ալավերդի', nameEn: 'Alaverdi', modernName: 'Alaverdi', coordinates: [41.0977, 44.6730], category: 'city', note: 'A Debed gorge city near major medieval monasteries and historic mining centers.' },
  { id: 'stepanavan', provinceId: 'gugark', nameHy: 'Ստեփանավան', nameEn: 'Stepanavan', modernName: 'Stepanavan', coordinates: [41.0096, 44.3853], category: 'city', note: 'A northern Armenian city on the Dzoraget plateau near Lori Berd.' },
  { id: 'spitak', provinceId: 'gugark', nameHy: 'Սպիտակ', nameEn: 'Spitak', modernName: 'Spitak', coordinates: [40.8372, 44.2673], category: 'city', note: 'A city in the upper Pambak valley at an important northern crossroads.' },
  { id: 'tashir', provinceId: 'gugark', nameHy: 'Տաշիր', nameEn: 'Tashir', modernName: 'Tashir', coordinates: [41.1207, 44.2846], category: 'city', note: 'A city in the historic Tashir district of Gugark, close to Armenia’s northern frontier.' },
  { id: 'tumanyan', provinceId: 'gugark', nameHy: 'Թումանյան', nameEn: 'Tumanyan', modernName: 'Tumanyan', coordinates: [40.9991, 44.6467], category: 'city', note: 'A small industrial city in the Debed canyon named after poet Hovhannes Tumanyan.' },
  { id: 'shamlugh', provinceId: 'gugark', nameHy: 'Շամլուղ', nameEn: 'Shamlugh', modernName: 'Shamlugh', coordinates: [41.1691, 44.7070], category: 'city', note: 'A small mining city in the forested mountains of northeastern Lori.' },
  ...
  { id: 'ashtarak', provinceId: 'ayrarat', nameHy: 'Աշտարակ', nameEn: 'Ashtarak', modernName: 'Ashtarak', coordinates: [40.2991, 44.3620], category: 'city', note: 'A city on the Kasagh River and the modern administrative center of Aragatsotn.' },
  { id: 'aparan', provinceId: 'ayrarat', nameHy: 'Ապարան', nameEn: 'Aparan', modernName: 'Aparan', coordinates: [40.5939, 44.3589], category: 'city', note: 'A highland city north of Mount Aragats on the historic route toward Shirak.' },
  { id: 'talin', provinceId: 'ayrarat', nameHy: 'Թալին', nameEn: 'Talin', modernName: 'Talin', coordinates: [40.3839, 43.8730], category: 'city', note: 'A city on the western Aragats plain near important early medieval monuments.' },
  { id: 'ararat-city', provinceId: 'ayrarat', nameHy: 'Արարատ', nameEn: 'Ararat', modernName: 'Ararat', coordinates: [39.8307, 44.7057], category: 'city', note: 'A modern industrial city in the Ararat plain beneath Mount Ararat.' },
  { id: 'masis', provinceId: 'ayrarat', nameHy: 'Մասիս', nameEn: 'Masis', modernName: 'Masis', coordinates: [40.0654, 44.4162], category: 'city', note: 'A modern city and railway junction in the central Ararat plain.' },
  { id: 'vedi', provinceId: 'ayrarat', nameHy: 'Վեդի', nameEn: 'Vedi', modernName: 'Vedi', coordinates: [39.9108, 44.7279], category: 'city', note: 'A city in the Vedi River valley at the southeastern edge of the Ararat plain.' },
  { id: 'armavir', provinceId: 'ayrarat', nameHy: 'Արմավիր', nameEn: 'Armavir', modernName: 'Armavir', coordinates: [40.1545, 44.0382], category: 'city', note: 'A modern city near the ancient royal center of Armavir in the Ararat plain.' },
  { id: 'metsamor-city', provinceId: 'ayrarat', nameHy: 'Մեծամոր', nameEn: 'Metsamor', modernName: 'Metsamor', coordinates: [40.0723, 44.2911], category: 'city', note: 'A modern city near the Metsamor archaeological complex and nuclear power station.' },
  { id: 'gyumri', provinceId: 'ayrarat', nameHy: 'Գյումրի', nameEn: 'Gyumri', modernName: 'Gyumri', coordinates: [40.7894, 43.8475], category: 'city', note: 'Armenia’s second-largest city and the principal urban center of historic Shirak.' },
  { id: 'artik', provinceId: 'ayrarat', nameHy: 'Արթիկ', nameEn: 'Artik', modernName: 'Artik', coordinates: [40.6173, 43.9757], category: 'city', note: 'A city on the northwestern slopes of Mount Aragats known for its volcanic tuff.' },
  { id: 'maralik', provinceId: 'ayrarat', nameHy: 'Մարալիկ', nameEn: 'Maralik', modernName: 'Maralik', coordinates: [40.5745, 43.8720], category: 'city', note: 'A small city in southern Shirak near medieval architectural monuments.' },
  { id: 'hrazdan', provinceId: 'ayrarat', nameHy: 'Հրազդան', nameEn: 'Hrazdan', modernName: 'Hrazdan', coordinates: [40.4975, 44.7662], category: 'city', note: 'A major modern city in the upper Hrazdan valley and the administrative center of Kotayk.' },
  { id: 'abovyan', provinceId: 'ayrarat', nameHy: 'Աբովյան', nameEn: 'Abovyan', modernName: 'Abovyan', coordinates: [40.2737, 44.6335], category: 'city', note: 'A modern city northeast of Yerevan in the historic Kotayk district.' },
  { id: 'charentsavan', provinceId: 'ayrarat', nameHy: 'Չարենցավան', nameEn: 'Charentsavan', modernName: 'Charentsavan', coordinates: [40.4033, 44.6426], category: 'city', note: 'An industrial city in the Hrazdan River corridor.' },
  { id: 'yeghvard', provinceId: 'ayrarat', nameHy: 'Եղվարդ', nameEn: 'Yeghvard', modernName: 'Yeghvard', coordinates: [40.3257, 44.4862], category: 'city', note: 'A historic settlement and modern city northwest of Yerevan.' },
  { id: 'nor-hachn', provinceId: 'ayrarat', nameHy: 'Նոր Հաճն', nameEn: 'Nor Hachn', modernName: 'Nor Hachn', coordinates: [40.3004, 44.5715], category: 'city', note: 'A modern city founded by survivors and descendants from historic Hadjin.' },
  { id: 'byureghavan', provinceId: 'ayrarat', nameHy: 'Բյուրեղավան', nameEn: 'Byureghavan', modernName: 'Byureghavan', coordinates: [40.3137, 44.5930], category: 'city', note: 'A small modern city in Kotayk northeast of Yerevan.' },
  { id: 'tsaghkadzor', provinceId: 'ayrarat', nameHy: 'Ծաղկաձոր', nameEn: 'Tsaghkadzor', modernName: 'Tsaghkadzor', coordinates: [40.5326, 44.7203], category: 'city', note: 'A mountain resort city centered on the historic Kecharis monastery complex.' },
  ...
  { id: 'ijevan', provinceId: 'utik', nameHy: 'Իջևան', nameEn: 'Ijevan', modernName: 'Ijevan', coordinates: [40.8788, 45.1485], category: 'city', note: 'The principal modern city of Tavush, located in the Aghstev River valley.' },
  { id: 'dilijan', provinceId: 'utik', nameHy: 'Դիլիջան', nameEn: 'Dilijan', modernName: 'Dilijan', coordinates: [40.7408, 44.8636], category: 'city', note: 'A forested mountain city known for its historic quarter and nearby monasteries.' },
  { id: 'berd', provinceId: 'utik', nameHy: 'Բերդ', nameEn: 'Berd', modernName: 'Berd', coordinates: [40.8813, 45.3901], category: 'city', note: 'A city in northeastern Armenia near the historic Tavush fortress region.' },
  { id: 'noyemberyan', provinceId: 'utik', nameHy: 'Նոյեմբերյան', nameEn: 'Noyemberyan', modernName: 'Noyemberyan', coordinates: [41.1725, 44.9992], category: 'city', note: 'A northern Tavush city overlooking the Debed and Kura approach routes.' },
  { id: 'ayrum', provinceId: 'utik', nameHy: 'Այրում', nameEn: 'Ayrum', modernName: 'Ayrum', coordinates: [41.1958, 44.8617], category: 'city', note: 'A small border city and railway point in the lower Debed valley.' },
  ...
  { id: 'kajaaran', provinceId: 'syunik', nameHy: 'Քաջարան', nameEn: 'Kajaran', modernName: 'Kajaran', coordinates: [39.1512, 46.1601], category: 'city', note: 'A high-mountain mining city west of Kapan.' },
  { id: 'agarak', provinceId: 'syunik', nameHy: 'Ագարակ', nameEn: 'Agarak', modernName: 'Agarak', coordinates: [38.8653, 46.1943], category: 'city', note: 'Armenia’s southernmost city, located near the Araxes River and the Iranian border.' },
  { id: 'dastakert', provinceId: 'syunik', nameHy: 'Դաստակերտ', nameEn: 'Dastakert', modernName: 'Dastakert', coordinates: [39.3833, 46.0167], category: 'city', note: 'A small highland city in the mountains of western Syunik.' },
  { id: 'gavar', provinceId: 'syunik', nameHy: 'Գավառ', nameEn: 'Gavar', modernName: 'Gavar', coordinates: [40.3589, 45.1267], category: 'city', note: 'The principal modern city on the western shore of Lake Sevan in historic Gegharkunik.' },
  { id: 'sevan-city', provinceId: 'syunik', nameHy: 'Սևան', nameEn: 'Sevan', modernName: 'Sevan', coordinates: [40.5473, 44.9417], category: 'city', note: 'A city on the northwestern shore of Lake Sevan near Sevanavank.' },
  { id: 'martuni', provinceId: 'syunik', nameHy: 'Մարտունի', nameEn: 'Martuni', modernName: 'Martuni', coordinates: [40.1380, 45.3065], category: 'city', note: 'A city on the southern shore of Lake Sevan in the historic Gegharkunik region.' },
  { id: 'vardenis', provinceId: 'syunik', nameHy: 'Վարդենիս', nameEn: 'Vardenis', modernName: 'Vardenis', coordinates: [40.1811, 45.7305], category: 'city', note: 'A highland city east of Lake Sevan near the Vardenis mountain range.' },
  { id: 'chambarak', provinceId: 'syunik', nameHy: 'Ճամբարակ', nameEn: 'Chambarak', modernName: 'Chambarak', coordinates: [40.5966, 45.3549], category: 'city', note: 'A city northeast of Lake Sevan in a high mountain basin.' },
  { id: 'yeghegnadzor', provinceId: 'syunik', nameHy: 'Եղեգնաձոր', nameEn: 'Yeghegnadzor', modernName: 'Yeghegnadzor', coordinates: [39.7639, 45.3324], category: 'city', note: 'The administrative center of Vayots Dzor in the Arpa River valley.' },
  { id: 'vayk', provinceId: 'syunik', nameHy: 'Վայք', nameEn: 'Vayk', modernName: 'Vayk', coordinates: [39.6889, 45.4667], category: 'city', note: 'A small city on the historic route through the Arpa valley.' },
  { id: 'jermuk', provinceId: 'syunik', nameHy: 'Ջերմուկ', nameEn: 'Jermuk', modernName: 'Jermuk', coordinates: [39.8417, 45.6694], category: 'city', note: 'A mountain spa city famous for its mineral springs and waterfalls.' },
